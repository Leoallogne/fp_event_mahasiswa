    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold"><i class="bi bi-tags me-2"></i>Manajemen Kategori</h2>
                <button class="btn btn-primary rounded-pill px-4" data-bs-toggle="modal" data-bs-target="#categoryModal"
                    onclick="resetForm()">
                    ...
                    <form method="POST" id="categoryForm">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="deskripsi" id="categoryDeskripsi"
                                    rows="3"></textarea>
                            </div>
                        </div>
