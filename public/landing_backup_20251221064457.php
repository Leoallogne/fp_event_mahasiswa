            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hero-content">
                        <h1 class="display-4 fw-bold mb-4">Kelola <span>Event Kampus</span> dengan Mudah</h1>
                        <p class="lead mb-5">Platform manajemen event terintegrasi untuk mahasiswa dan organisasi kampus. Buat, kelola, dan ikuti event dengan lebih efisien.</p>
                        <div class="hero-buttons d-flex gap-3">
                            <a href="register.php" class="btn btn-primary btn-custom btn-lg-custom">
                                <i class="bi bi-rocket me-2"></i>Mulai Sekarang
                            </a>
                            <a href="#fitur" class="btn btn-outline-light btn-custom btn-lg-custom">
                                <i class="bi bi-play-circle me-2"></i>Lihat Demo
                            </a>
                        </div>
                        <div class="mt-5 d-flex align-items-center">
                            <div class="d-flex">
                                <img src="https://randomuser.me/api/portraits/women/32.jpg" class="rounded-circle border border-3 border-white" width="40" height="40" alt="User" style="margin-right: -10px;">
                                <img src="https://randomuser.me/api/portraits/men/32.jpg" class="rounded-circle border border-3 border-white" width="40" height="40" alt="User" style="margin-right: -10px;">
                            ...
                            <div class="ms-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="ms-2 text-white">5.0 (1.2k+ Ulasan)</span>
                                </div>
                                <p class="mb-0 text-white-50 small">Digunakan oleh 5.000+ pengguna aktif</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="hero-image text-center">
                        <img src="https://img.freepik.com/free-vector/event-management-background-with-elements_52683-36974.jpg" alt="Event Management" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                ...
                <div class="col-lg-6 hero-content">
                    <h1>
                        ...
                        Kelola Event Mahasiswa<br>
                        <span style="font-size: 0.7em; opacity: 0.9;">dengan Mudah</span>
                    </h1>
                    <p>
                        Sistem manajemen event yang lengkap untuk mengelola kegiatan mahasiswa. 
                        Daftar event, kelola peserta, dan dapatkan analitik lengkap dalam satu platform.
                    </p>
                ...
                <div class="col-lg-6 text-center">
                    <div style="font-size: 15rem; opacity: 0.2; animation: float 3s ease-in-out infinite;">
