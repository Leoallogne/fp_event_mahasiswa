...
class Auth {
    ...
    public function requireLogin() {
        if (!$this->isLoggedIn()) {
            header('Location: /final/mahasiswa_fp/public/login.php');
            exit;
        }
    }
    ...
    public function requireAdmin() {
        $this->requireLogin();
        if (!$this->isAdmin()) {
            header('Location: /final/mahasiswa_fp/public/index.php');
            exit;
        }
    }
    ...
    public function requireUser() {
        $this->requireLogin();
        if (!$this->isUser()) {
            header('Location: /final/mahasiswa_fp/public/admin/dashboard.php');
            exit;
        }
    }
